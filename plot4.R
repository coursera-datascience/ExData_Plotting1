...
# hpc[,2] <- strptime(hpc[,2], format = "%Y-%m-%d %H:%M:%S")
...
par(mfcol=c(2,2))
plot(hpc[,1], hpc[,2], type="l", xlab="", ylab="Global Active Power")
...
plot(hpc[,1], hpc[,4], type="l", xlab="datetime", ylab="Voltage")
plot(hpc[,1], hpc[,3], type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()
